module NestedAttributesForExtJS
  module Macros
    ...
    def self.included(base)
      ...
      base.class_inheritable_accessor :nested_attributes_extjs_options, :instance_writer => false
      base.nested_attributes_extjs_options = {}
    end
	...
	attributes_collection = if options[:id_in_key]
	  ...
	  attributes_collection.map { |_, attributes| attributes }
	end
      end
      ...
      all_records = association.loaded? ? association.to_a : association
